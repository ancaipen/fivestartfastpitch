...
class InfoModel extends ItemModel
{
	...
	public function getItem($id = null)
	{
		if ($this->_item === null)
		{
			...
			if (empty($id))
			{
				...
				$id = Factory::getApplication()->input->get('tournament_id');
	...
	public function GetMenuHtml($tournament_id='')
    {
        ...
        $html .= '<ul>';
        $html .= '<li><a href="'.$reg_link.'" style="padding: 0 0 0 20px" class="tp-button home-slider-button-blue">Register Now</a></li>';
        $html .= '<li><a href="index.php?option=com_ts&view=results&tournament_id='.$tournament_id.'" style="padding: 0 0 0 10px" class="tp-button home-slider-button">Schedule/Results</a></li>';
        $html .= '</ul></div>';
        return $html;
    }
