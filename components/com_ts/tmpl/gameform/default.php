...
<div class="game-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-game"
			  action="<?php echo Route::_('index.php?option=com_ts&task=gameform.save'); ?>"
	...
	<input type="hidden" name="jform[home_seed]" value="<?php echo isset($this->item->home_seed) ? $this->item->home_seed : ''; ?>" />

	<input type="hidden" name="jform[visitor_seed]" value="<?php echo isset($this->item->visitor_seed) ? $this->item->visitor_seed : ''; ?>" />
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_ts&task=gameform.cancel'); ?>"
