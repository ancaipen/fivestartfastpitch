...
<div class="tournament-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-tournament"
			  action="<?php echo Route::_('index.php?option=com_ts&task=tournamentform.save'); ?>"
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_ts&task=tournamentform.cancel'); ?>"
