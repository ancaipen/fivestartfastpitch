 ...
 * @since  1.0.0
 */
class TournamentformModel extends FormModel
{
	private $item = null;
	...
	{
		// Get the form.
		$form = $this->loadForm('com_ts.tournament', 'tournamentform', array(
						'control'   => 'jform',
						'load_data' => $loadData
				)
		);
	...
	{
		$id    = (!empty($data['id'])) ? $data['id'] : (int) $this->getState('tournament.id');
	...
	public function delete($id)
	{
		...
		if (empty($id))
		{
			$id = (int) $this->getState('tournament.id');
		}
